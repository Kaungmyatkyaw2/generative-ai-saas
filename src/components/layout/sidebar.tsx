...
import { Code, Image, LayoutDashboard, MessageSquare, Music, Settings, Video } from 'lucide-react';
                ...
                <div className='w-full space-y-2'>
                    {routes.map((route) => (
                        <Link
                            key={route.href}
                            href={route.href}
                            className='group flex w-full cursor-pointer rounded-lg p-3 text-sm font-medium transition hover:bg-white/10'
                        >
